...
import { router as routerProductsMongo  } from "./routes/products.router.mongo.js"; 
import { router as routerCartsMongo} from "./routes/carts.router.mongo.js"; 
...
app.use(express.static(archivoPublic)); 
